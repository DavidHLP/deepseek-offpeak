...
// exists to prevent.
//
// `apiKeySource` is "environment" or "" — where the balance key was found, so a
// missing-key report says where it looked. The environment is the only place it
// is read from; see lib/Balance.js.
//
